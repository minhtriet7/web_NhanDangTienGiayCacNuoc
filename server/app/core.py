...
def call_debate_agent(agent_role, original_json, peers_context):
    ...
    """
    try:
        # Dùng Llama 3.3 70B của Groq cho vòng tranh biện vì suy luận logic cực mạnh và tốc độ siêu nhanh
...
def run_consensus_system(image):
    ...
    # Trả về kết quả (tương thích 100% với giao diện React của bạn)
    return {
